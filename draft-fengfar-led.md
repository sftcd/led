...
current practice in detail, as a basis for the discussion that follows.
...
AI provides a signal; the reading and judgment are the author's.
...
The author reviews this draft critically — not for grammatical correctness,
...
The author personally reviews the final text before sending. The AI does
not send mail autonomously. The author takes full responsibility for
anything sent under their name.
...
accurate to the individual rather than more generic.
...
AI language systems operate effectively within known boundaries. Given a
...
More fundamentally, AI excels at operating within accumulated knowledge.
...
AI systems have a structural limitation that is frequently underestimated:
they cannot originate.

They recombine, extrapolate, and interpolate within the space of what they
...
of existing terrain — remains a human capacity.

The ideas that change a field do not emerge from pattern completion. They
...
available to a system trained to operate within existing frameworks.

## The Symmetry

Humans have the inverse limitation. We are slow to acquire and integrate
...
constant cognitive cost.

AI removes these constraints. A researcher with AI assistance can engage
...
The symmetry is clean: humans originate, AI executes. Humans open new
...
The position, the argument, and the judgment are formed by the human before
...
This boundary is not always clean in practice. Using AI to stress-test an
...
deceiving anyone, but because it has become a better instrument.

This is the direction Odyssey points toward. Over time, the gap between
...
while developing original contributions — become achievable.
...
possibilities that neither possesses alone.
